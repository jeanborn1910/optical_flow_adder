...
def browse_video():
    file_path = filedialog.askopenfilename(title="Choisir un fichier vidéo", filetypes=[("Video files", "*.avi")])
...
def submit():
    ...
    if not video_path:
        ...
        if not Path(video_path).exists():
            ...
            messagebox.showerror("Erreur", "Le fichier vidéo DOIT être au format .avi")
            return
